    ...
    try:
        ...
        if target_uuid:
            ...
            if target_ws is not None:
                ...
                logger.bind(target_uuid=target_uuid, connections=connections).warning('Target WS not found!')

    except Exception:
        logger.bind(target_uuid=target_uuid, target_ws=target_ws).exception('send_to_target exception')
